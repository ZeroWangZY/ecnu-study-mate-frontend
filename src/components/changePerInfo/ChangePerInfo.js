...
class ChangePerInfo extends Component{
    ...
    handleSend = () => {
        ...
        if(this.state.oldPwd===""||this.state.password1===""||this.state.password2===""||this.state.name===""||this.state.email===""||this.state.username===""||this.state.sex===""||this.state.phone===""){
         ...
         //   this.initState();
            ...
            this.props.send(this.state.name,this.state.username,this.state.email,this.state.password1,this.state.oldPwd,this.state.sex,this.state.phone);
        }
...
const mapDispatchToProps = dispatch =>({
    send: (name,username,email,password,oldPwd,sex,phone) => dispatch(changePerInfo(name,username,email,password,oldPwd,sex,phone)),
